...
uses process, controls, StrUtils, LazFileUtils{$ifndef STANDALONEDEBUG}, symbolhandler,
...
begin
  ...
  begin
    ...
    try
      ...
      SplitCmdLine(command,executable,params);
      p.Executable:=executable;
      SplitCmdLineParams(params,p.Parameters);
...
begin
  ...
  try
    ...
    begin
      ...
      result:=true;
      addressThatCausedBreakpoint:=High(QWord);
...
begin
  result:=socket<>InvalidGdbSocket;
end;
...
begin
  ...
  try
    ...
    begin
      ...
      if socket=InvalidGdbSocket then
