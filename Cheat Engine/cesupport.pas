    ...
    begin
      ...
      begin
       // BringToFront;
        ...
        url:=getbase+'?cewidth='+inttostr(clientwidth)+'&ceheight='+inttostr(clientheight)+'&fn='+extractfilename(ChangeFileExt(application.ExeName,''))+'&counter='+inttostr(counter)+getoptionalstring;
